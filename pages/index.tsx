...
const Home: NextPage = () => {
  ...
  return (
    <>
      <div className="relative bg-white w-full overflow-y-auto flex flex-col items-center justify-start py-0 pr-[137px] pl-[138px] box-border gap-[289px] text-center text-81xl text-black font-inter sm:gap-[20px] sm:items-center sm:justify-center">
          ...
          <div className="self-stretch [backdrop-filter:blur(4px)] flex flex-row items-center justify-between pt-0.5 px-0 pb-0 md:items-center md:justify-start sm:flex sm:w-auto sm:[align-self:unset] sm:items-center sm:justify-start">
            ...
            <div className="w-[542px] flex flex-row items-start justify-start md:hidden sm:hidden">
              <div className="flex-1 flex flex-row items-center justify-center py-0 px-2.5 gap-[25px]">
                <button className="cursor-pointer py-4 px-5 bg-[transparent] flex-1 rounded-lg box-border h-[52px] flex flex-row items-center justify-center border-[1px] border-solid border-black hover:rounded-lg hover:shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)]">
                ...
                >
                  <div className="relative text-base leading-[20px] font-medium font-inter text-gray-300 text-center">
                    Social Media
                  </div>
                </button>
                <button
                  className="cursor-pointer [border:none] py-[5px] px-5 bg-black flex-1 rounded-lg h-[52px] flex flex-row items-center justify-center box-border hover:bg-lightgray-100 active:shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)]"
        ...
        <div className="self-stretch flex-1 overflow-hidden shrink-0 flex flex-row items-center justify-center py-[27px] px-[353px] sm:w-auto sm:[align-self:unset] sm:h-auto sm:flex-row sm:gap-[0px] sm:items-center sm:justify-center sm:pt-[100px] sm:px-0 sm:pb-0 sm:box-border">
          <div className="relative leading-[20px] font-semibold sm:flex-1 sm:h-[300px]">
            HOME
          </div>
        </div>
        <section className="self-stretch flex flex-row items-center justify-center gap-[50px] text-center text-81xl text-black font-inter sm:w-auto sm:[align-self:unset] sm:h-auto sm:flex-col sm:gap-[0px] sm:items-center sm:justify-center">
